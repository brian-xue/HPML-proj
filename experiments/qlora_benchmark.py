...
EXPERIMENT = {
    "name": "qlora_benchmark",
    "description": "QLoRA benchmark on GSM8K (4-bit quantized base model + LoRA adapters).",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the QLoRA benchmark experiment.")
