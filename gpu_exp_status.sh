...
echo
report_run "ddp_scaling" "ddp_scaling"
report_run "ddp_profile_plain" "ddp_scaling_plain"
report_run "fsdp_scaling" "fsdp_scaling"
report_run "fsdp_profile_plain" "fsdp_scaling_plain"
echo
echo "Note: scaling runs currently reuse one experiment name per method, so this"
echo "status report shows the latest DDP/FSDP run but does not separate 1/2/4-GPU runs."
